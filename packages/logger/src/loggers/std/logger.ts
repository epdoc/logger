...
import * as Otlp from '../otlp/mod.ts';
 ...
 * - `critital`: For critical, non-recoverable issues.
 ...
 */
export class StdLogger<M extends MsgBuilder.Abstract> extends Otlp.Logger<M> implements Logger.ILoggerEmitter {
  /**
