...
- msgbuilder date method now detects distant past and future

## [0.1.14] - 2026-04-02

- Added defensive guard to style fn to ensure it's a fn.

## [0.1.13] - 2026-04-02

- Added ibool() icon output

## [0.1.11] - 2026-04-02

- Added iarrow and icon variations

## [0.1.9] - 2026-03-24

- Handle missing path in relative() method
...
- relative method now uses HOME or CWD

## [0.1.5] - 2026-02-19

- Added dim and bold methods, changed our default color scheme
...
- Make V2 (RGB24) the default console style theme
